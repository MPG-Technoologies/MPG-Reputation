...
/**
 * Renders a responsive, accessible, neutral review request HTML email.
 ...
 */
export function renderReviewRequestHtml(options: HtmlTemplateOptions): string {
  ...
  const previewText = `${safeBusinessName} invited you to share your experience.`
...
<head>
  ...
  <title>Share your experience with ${safeBusinessName}</title>
  <style>
          ...
          <tr>
            <td class="content-padding" style="padding: 36px 32px;">
              ...
              <p class="text-secondary" style="margin: 0 0 20px 0; font-size: 15px; line-height: 1.6; color: #334155;">
                ${safeBusinessName} invited you to share your experience following your recent service. If you&#39;d like to leave a review, use the link below.
              </p>
